...
export default function Overview() {
  ...
  return (
    <>
      ...
      <footer className="mt-10 light:text-white dark:text-gray-300 py-6">
        <div className="container mx-auto text-center">
          <img 
            className="mx-auto mb-4 h-12 w-auto dark:hidden" 
            src="uni_logo.png" 
            alt="Elmhurst University Logo (Light Mode)" 
          />
          <img 
            className="mx-auto mb-3 h-10 w-auto hidden dark:block " 
            src="elmhurst_uni.png" 
            alt="Elmhurst University Logo (Dark Mode)" 
          />
          <p className="text-sm underline">Contact Us</p>
          <p className="text-sm">Email: servicedesk@elmhurst.edu</p>
          <p className="text-sm">Phone: +1 (630) 617-3400</p>
          <p className="text-sm">Address: 190 South Prospect Ave, Elmhurst, Illinois</p>
          <p className="text-xs mt-4">&copy; {new Date().getFullYear()} Elmhurst University. All rights reserved.</p>
        </div>
      </footer>
    </>
  )
