  ...
  return (
    <>
      <div className="flex min-h-screen flex-1 flex-col justify-center px-4 lg:px-6"
        style={{
          backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.8), rgba(70, 130, 180, 0.8)), url('/elmhurst_back.jpg')",
          backgroundSize: "cover",
          backgroundPosition: "center",
          backgroundRepeat: "no-repeat",
        }}
        >
        <div className="bg-white dark:bg-black shadow-lg rounded-lg p-6 sm:mx-auto sm:w-full sm:max-w-sm">
